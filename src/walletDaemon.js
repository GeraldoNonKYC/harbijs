...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/harbiwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { harbiwalletd } = gRPC.loadPackageDefinition(packageDefinition).harbiwalletd

    this._client = new harbiwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
